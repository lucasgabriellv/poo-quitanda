...
import com.lucas.quitandaria.model.Cliente;
import com.lucas.quitandaria.model.Validacao;
import com.lucas.quitandaria.controller.ClienteController;
...
public class ClienteCadastroAlteracaoView extends javax.swing.JInternalFrame {
    ...
    private void lbPreencherAutomaticoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbPreencherAutomaticoMouseClicked
        txtNome.setText("Lucas Gabriel Lins Veloso");
        txtCpf.setValue("099.098.254-81");
        txtDataNascimento.setValue("11/05/2002");
        rdbMasculino.setSelected(true);
        cboEstadoCivil.setSelectedIndex(2);
        cboEstado.setSelectedIndex(2);
        txtCidade.setText("Maceió");
        txtBairro.setText("Barro Duro");
        txtLogradouro.setText("Rua A");
        txtNumero.setText("1");
        txtEmail.setText("lglv1@aluno.ifal.edu.br");
        txtTelefoneCelular.setText("82988887777");
        txtTelefoneOutros.setText("558255555555");
        txtObservacoes.setText("Dono!");
